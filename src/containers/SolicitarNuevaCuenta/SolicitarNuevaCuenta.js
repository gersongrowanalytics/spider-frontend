...
import './solicitarNuevaCuenta.css'
    ...
    >
      ...
      >
        <div style={{width : '100%', height : '100%', alignItems: 'center', display:'flex'}}>
          ...
          <h1 className="tituloIniciarSesion">SOLICITAR UNA <br/>NUEVA CUENTA</h1>
          ...
          <Form
            ...
            className="gx-Recuperar-form gx-form-row0">
              ...
              <div id="campoInputCorreo">
                <Form.Item
                  initialValue=""
                  rules= {[{required: true, message: 'Es necesario un correo electrónico!'}]}
              ...
              <span id="txtInputContrasenia">Contraseña</span>
              <div id="campoInputContrasenia">
                <Form.Item
                  initialValue=""
